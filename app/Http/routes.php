...
Route::get('sobre-nos', array('as' => 'sobre-nos', function () {
    return View::make('aboutus');
}));

Route::get('profissionais', array('as' => 'profissionais', function () {
    return View::make('index');
}));
...
Route::get('search/states', 'SearchController@getState');
Route::get('search/cities/{id}', 'SearchController@getCity');
Route::get('search/neighbourhoods/{id}', 'SearchController@getNeighbourhood');
