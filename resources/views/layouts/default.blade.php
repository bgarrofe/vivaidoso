...
<body class="indent">
    ...
    <header>
        <!-- Nav bar Start -->
        <nav class="navbar navbar-default navbar-fixed-top top-header">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li {!! (Request::is('sobre-nos') ? 'class="active"' : '') !!}><a href="{{ URL::to('sobre-nos') }}"> Sobre nós</a>
                    </li>
                    <li {!! (Request::is('profissionais') ? 'class="active"' : '') !!}><a href="{{ URL::to('profissionais') }}"> Profissionais</a>
                    </li>
                    <li {!! (Request::is('contact') ? 'class="active"' : '') !!}><a href="{{ URL::to('contact') }}">Contatos</a>
                    </li>
    ...
    <div class="copyright">
        <div class="container">
        <p>Copyright &copy; Viva Idoso, 2016</p>
        </div>
    </div>
